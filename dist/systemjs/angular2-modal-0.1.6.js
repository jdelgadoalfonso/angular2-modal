...
System.registerDynamic("components/bootstrapModalContainer", ["angular2/core", "../models/ModalDialogInstance", "../providers/Modal"], true, function($__require, exports, module) {
  ...
  var BootstrapModalContainer = (function() {
    ...
    BootstrapModalContainer.prototype.ngAfterViewInit = function() {
      var _this = this;
      this.componentLoader.loadNextToLocation(this.dialogInstance.componentType, this._viewRef, this.dialogInstance.modalDataBindings).then(function(contentRef) {
        _this.dialogInstance.contentRef = contentRef;
      });
    };
    __decorate([core_1.ViewChild('modalDialog', {read: core_1.ViewContainerRef}), __metadata('design:type', core_1.ViewContainerRef)], BootstrapModalContainer.prototype, "_viewRef", void 0);
    ...
    }), __metadata('design:paramtypes', [ModalDialogInstance_1.ModalDialogInstance, Modal_1.Modal, core_1.DynamicComponentLoader])], BootstrapModalContainer);
...
System.registerDynamic("components/modalBackdrop", ["angular2/core", "../models/ModalDialogInstance", "./bootstrapModalContainer"], true, function($__require, exports, module) {
  "use strict";
  ;
  var define,
      global = this,
...
System.registerDynamic("providers/Modal", ["angular2/core", "../framework/ModalInstanceStack", "../models/ModalConfig", "../models/ModalDialogInstance", "../components/modalBackdrop", "../presets"], true, function($__require, exports, module) {
  "use strict";
  ;
  var define,
      global = this,
  ...
  var Modal = (function() {
    ...
    Modal.prototype.open = function(componentType, viewRef, bindings, config) {
      ...
      return this.createBackdrop(viewRef, dialogBindings).then(function(backdropRef) {
    ...
    Modal = __decorate([core_1.Injectable(), __param(1, core_1.Optional()), __metadata('design:paramtypes', [core_1.DynamicComponentLoader, ModalConfig_1.ModalConfig])], Modal);
    return Modal;
  }());
  exports.Modal = Modal;
  return module.exports;
